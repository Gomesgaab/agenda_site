<x-layout>
    ...
    <div class="row align-items-start" style="background:#474F7A; margin:60px;">
        ...
        <div class="col-3" >
            <div class="card  mb-3 0 text-white" style="max-width: 18rem; background:#81689D; margin:20px;">
                ...
                <div class="d-grid gap-2 col-6 mx-auto" style="margin:10px; ">
                    <button style=" background:#FFD0EC; border-color:#FFD0EC;" class="btn text-dark" type="submit" href="home" data-mdb-ripple-init>cadastrar</button>
                </div>
                </form>
        ...
        <div class="col text-white" >
            <p>Bem vindo(a) ao NoteDay</p>
        </div>
    </div>



    <div class="container.container-xxl" style="background:#474F7A;">
